...
export default function RecipeView() {
  ...
  const deleteRecipe = () => {
    if (id != null) {
      RecipeEndpoint.deleteRecipe(id)
        .then(() => {
          Notification.show("Recipe was successfully deleted", {
            theme: "success",
          });
          navigate("/recipe");
        })
  ...
  return (
    <div className="px-5 py-4">
      ...
      <div className="container mx-auto flex md:flex-row flex-col items-center">
        <div className="lg:flex-grow w-full md:w-1/2 lg:pr-16 md:pr-8 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
